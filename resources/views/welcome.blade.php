...
<head>
    ...
    <link rel="icon" type="image/png" href="/images/logo_barrio.png">
    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-slate-100 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3 group">
                <img src="/images/logo_barrio.png" alt="Pino Montano Logo" class="w-10 h-10 rounded-xl shadow-lg shadow-emerald-500/20 group-hover:scale-105 transition-transform object-contain">
                <div>
    ...
    <footer class="mt-auto bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-3">
                <img src="/images/logo_barrio.png" alt="Pino Montano Logo" class="w-8 h-8 rounded-lg object-contain">
                <div class="text-left">
